            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <a href="{{ route('property.types.index') }}" class="btn-back text-decoration-none">
                    ...
                    <div class="card card-modern">
                        ...
                        <div class="card-body p-3 p-md-3">
                            <form method="POST" action="{{ route('property.types.edit', $data_obj->id) }}" id="editType" enctype="multipart/form-data">
                                @csrf
