<div class="d-inline-flex dropdown ms-2">
    ...
    <div class="dropdown-menu dropdown-menu-end" style="">
            <a href="{{ route('users-management.users.edit', $row->id) }}" class="dropdown-item">
            ...
            <a href="{{ route('users-management.users.delete', $row->id) }}" class="dropdown-item" onclick="deleteRecord(event)">
