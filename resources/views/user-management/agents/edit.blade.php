            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <a href="{{ route('users-management.agents.index') }}" class="btn-back text-decoration-none">
                    ...
                    <form action="{{ route('users-management.agents.dit', $property_info->id) }}" method="POST" id="editProperty" enctype="multipart/form-data">
                        @csrf
