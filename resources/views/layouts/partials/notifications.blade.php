                ...
                <div class="flex-fill">
                    ...
                    <div class="my-2">
                        <a href="index.html#" class="btn btn-success btn-sm me-1">
                            <i class="ph ph-checks ph-sm me-1"></i>
                            Approve
                        </a>
            ...
            <div class="d-flex align-items-start mb-3">
                <div class="me-3">
                    <div class="bg-success bg-opacity-10 text-success rounded-pill">
                        <i class="ph ph-calendar-plus p-2"></i>
                    </div>
                </div>
                <div class="flex-fill">
                    ...
                    <div class="my-2">
                        <a href="index.html#" class="btn btn-primary btn-sm">
                            <i class="ph ph-calendar-plus ph-sm me-1"></i>
                            Add to calendar
                        </a>
                    </div>
            ...
            <div class="d-flex align-items-start mb-3">
                <div class="me-3">
                    <div class="bg-primary bg-opacity-10 text-primary rounded-pill">
                        <i class="ph ph-users-four p-2"></i>
                    </div>
                </div>
                <div class="flex-fill">
