/*
SpellingNumber! jQuery Plugin (https://github.com/faizalmansor/jquerySpellingNumber)
@author Mhammad Attar (mhammad.attar@gmail.com) [https://ToLastBit.com]
@company To Last Bit [https://www.ToLastBit.com]
[Original NodeJs base code [https://github.com/yamadapc/js-written-number/] (thanks!)]

SpellingNumber v1.0.0
...
/**
 * @Param options.i18n.{LANG}.DigitsLengthW2F
 * Digits length convertion from Wholes to Fraction example:
 * (Ton to Kg = 1000 so 3 Digits,  wholesUnit = "Ton", fractionUnit="Kg", DigitsLengthW2F=3 )
 * 
 */
